...
class SMACCs_Ammo_Paintball: Ammunition_Base {};

class SMACCs_PaintballGun_ColorBase: Ruger1022_Base {
...
modded class PluginRecipesManager {
    override void RegisterRecipies()
	{
		...
		RegisterRecipe(new SMACCs_FillPaintballDrum);
    };
};
class SMACCs_FillPaintballDrum extends RecipeBase {
	override void Init()
	{
		m_Name = "Fill with Paintballs";
		...
		//INGREDIENTS
		//ingredient 1 //you can insert multiple ingredients this way
		InsertIngredient(0,"SMACCs_Ammo_Paintball");
		...
		//ingredient 2
		InsertIngredient(1,"SMACCs_Mag_PaintballDrum");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SMACCs_Mag_PaintballDrum");//add results here
